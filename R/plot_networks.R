...
# ggsave("figures/groupers_mass_network_overall.png", device = "png", dpi = 300, width = 4, unit = "in")

plot_graph(biomass_models$dip_mass, "Seabreams")
# ggsave("figures/seabreams_mass_network_overall.png", device = "png", dpi = 300, width = 4, unit = "in")

plot_graph(biomass_models$herb_mass, "Herbivores")
# ggsave("figures/herb_mass_network_overall.png", device = "png", dpi = 300, width = 4, unit = "in")
